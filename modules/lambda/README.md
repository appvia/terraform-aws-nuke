...
| <a name="input_lambda_architecture"></a> [lambda\_architecture](#input\_lambda\_architecture) | The architecture to use for the Lambda function - must match the platform the container image was built for | `string` | `"x86_64"` | no |
