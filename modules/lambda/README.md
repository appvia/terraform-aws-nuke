...
| <a name="input_lambda_architecture"></a> [lambda\_architecture](#input\_lambda\_architecture) | The architecture to use for the Lambda function - must match the platform the container image was built for | `string` | `"arm64"` | no |
